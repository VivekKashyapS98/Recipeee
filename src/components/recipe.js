...
class Recipe extends Component {
    constructor(props) {
        ...
        this.state = {
            db: [
                {
                    name: 'Perfect Fluffy Pancake',
                    img: 'https://lh3.googleusercontent.com/JrpPHGNV0Ze5HsrR87MOvMdNaI4Iy_S0jxL-w5BCwgrbO-W182m3R82O59BghAgRVxJtVAEP3JTTuHDy310W-A=s640-c-rj-v1-e365',
                    instr: ['In a bowl, add the flour and baking powder together, stirring to combine',
                ...
                {
                    name: 'Rava Idli',
                    img: 'https://i.ytimg.com/vi/BfGsHhRlJZ8/maxresdefault.jpg',
                    instr: [
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <AddRecipee addNew={this.addNewRecipe} />
